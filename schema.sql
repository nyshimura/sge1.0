...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 17/01/2026 às 22:31
...
CREATE TABLE `enrollments` (
  ...
  `customDueDay` int(2) DEFAULT NULL COMMENT 'Dia de vencimento personalizado (1-31)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
